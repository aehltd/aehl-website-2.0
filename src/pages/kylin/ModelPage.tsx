...
const KylinModelPage = () => {
  return (
    <div className="flex flex-col items-center">
      <h1>AEHL Kylin Cloud Business Model</h1>
      <img
        ...
        alt="bg"
      />
      <div className="w-3/4 m-8 flex space-x-8">
        <div>
          <h1>About Us</h1>
          <p>
          ...
          <Collapse accordion>
            ...
            <Panel header="KylinCloud BBP Model" key="2">
              <p>
                ...
                ever for businesses to connect with the right talents and manage
