      ...
      <div className="row">
        ...
        <div className="flex row space-x-8">
          <div>
            ...
            <p>
              AEHL US plans to supply power to a data center in Midland, Texas. This
              energy supply business began operation in the third quarter of 2024.
              Further, AEHL US also plans to generate revenue by securing hosting
              sites for cryptocurrency mining operators as it leverages anticipated
              cost-effective electricity costs.
            </p>
          </div>
          <div>
          <h2>Livestreaming Ecommerce Business</h2>
          <p>
            Our livestreaming ecommerce business is operated in China through our
            51% subsidiary, Hainan Kylin and provide one-stop solutions for our
            customers to adopt the emerging sales channel of livestreaming
            ecommerce. We believe that livestreaming ecommerce is an important
            growth engine for consumer good brands as it leverages the content of
            livestreaming to boost sales.
          </p>
          <p>
            ...
            influencers to provide engaging content to livestream who then promote
            our customers’ products on various livestreaming platforms.
          </p>
        </div>
        </div>
        <div className="row">
